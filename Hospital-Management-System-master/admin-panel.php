...
.btn-primary{
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
     <ul class="navbar-nav mr-auto">
       <li class="nav-item">
        <a class="nav-link logout" href="logout.php"><i class="fa fa-sign-out" aria-hidden="true"></i>Logout</a>
      </li>
       <li class="nav-item">
                  ...
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body">
                      ...
                      <p class="links cl-effect-1">
                        <a href="#list-home" onclick="clickDiv('#list-home-list')" class='appointment'>
                          Book Appointment
                        </a>
                      </p>
                    </div>
          ...
          <div class="card">
            <div class="card-body">
                ...
                <div class="row">
                  ...
                  ?> -->
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="col-md-8">
                          <select name="spec" class="form-control specialisation" id="spec">
              ...
              <div class="col-md-4"><label for="doctor">Doctors:</label></div>
                <div class="col-md-8">
                    <select name="doctor" class="form-control doctor" id="doctor" required="required">
              ...
              document.getElementById('spec').onchange = function updateSpecs(e) {
                ...
                document.getElementById('doctor1').value = document.querySelector(`[value=${values}]`).getAttribute('data-value');
                  ...
                  <div class="col-md-8"><input type="date" class="form-control datepicker date" name="appdate"></div><br><br>

                  <div class="col-md-4"><label>Appointment Time</label></div>
                  <div class="col-md-8">
                    <!-- <input type="time" class="form-control" name="apptime"> -->
                    <select name="apptime" class="form-control time" id="apptime" required="required">
                  ...
                  <div class="col-md-4">
                    <input type="submit" name="app-submit" value="Create new entry" class="btn btn-primary create" id="inputbtn">
                  </div>
