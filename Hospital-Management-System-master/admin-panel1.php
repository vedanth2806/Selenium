...
.btn-primary{
  ...
  <body style="padding-top:50px;">
   <div class="container-fluid" style="margin-top:50px;">
    ...
    <a href="delete_table_content.php?table_name=appointmenttb" onclick="return confirm('Are you sure you want to delete all rows from this table?');">Delete All Apointments</a>
